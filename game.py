...
def legalCheck(move, board): #TODO remake
    x = move[0]
    y = move[1]
    d = move[2]
...
def pointSpaceUpdate(move, board): #TODO fix
    i = 1
...
def floodfill(boardIn, y, x, p1): #TODO return a floodfilled matrix from point y,x
    print("placeholder")
